...
> crouch, blue ghosts the held pose, with a distance based alpha falloff.
...
1. Grab the latest `AMP_AniMatePro_vX.Y.zip` from the
   ...
   to `main` publishes a fresh, version named build), or build one locally with
   `python build.py`.
2. In Blender 5.1 open **Edit > Preferences > Add-ons**, use the dropdown at the
   top right, choose **Install from Disk**, and pick the zip.
3. Enable **AniMate - AniMate Pro**.

The tools live in the **Graph Editor / Dope Sheet header** (grouped into the
categories below) and in the **3D Viewport sidebar** (`N`, Animation tab) for
Onion Skins. Most tools open an options popover; the screenshots below show
those panels, captured on the example rig in `docs/Rig1.blend`.

---

## Tools

Jump to a category: [Flagship tools (new in this build)](#flagship-tools-new-in-this-build) | [Tools](#tools) | [Keyframes](#keyframes) | [Toggles](#toggles) | [Utils](#utils) | [View](#view) | [Selection](#selection) | [Editor switches](#editor-switches) | [Sidebar tools](#sidebar-tools)
...
<img src="docs/images/tool_time_visualizer.png" alt="Time Visualizer options" width="360">
...
<img src="docs/images/tool_anim_sculpt.png" alt="Anim Sculpt options" width="360">
...
<img src="docs/images/tool_anim_curves.png" alt="Anim Curves options" width="360">
...
<img src="docs/images/tool_timewarper.png" alt="Anim TimeWarper options" width="360">
...
<img src="docs/images/tool_anim_lattice.png" alt="Anim Lattice options" width="360">
...
<img src="docs/images/tool_anim_blast.png" alt="Anim Blast options" width="360">
...
<img src="docs/images/tool_keyframer.png" alt="Keyframer options" width="360">
...
<img src="docs/images/tool_flex_mopaths.png" alt="Flex Mopaths options" width="360">
...
<img src="docs/images/tool_realtime_mopaths.png" alt="Realtime Mopaths options" width="360">
...
<img src="docs/images/tool_euler.png" alt="Euler Filter options" width="360">
...
<img src="docs/images/tool_selection_sets.png" alt="Selection Sets options" width="360">
...
<img src="docs/images/tool_stepper.png" alt="Stepper options" width="360">
...
<img src="docs/images/tool_camera_stepper.png" alt="Camera Stepper options" width="360">
...
docs/
  TOOLS.md                 the same tool reference, standalone
  AUDIT.md                 Blender 5.1 audit, 204 findings
  FEATURES.md              Onion Skin and Time Visualizer in depth
...
- [docs/FEATURES.md](docs/FEATURES.md): Onion Skin and Time Visualizer usage and test steps.
- [docs/AUDIT.md](docs/AUDIT.md): the full Blender 5.1 audit and the applied fixes.
- [docs/TOOL_CONCEPTS.md](docs/TOOL_CONCEPTS.md): designs for two advanced tools, Whiplash and Groundwork.
