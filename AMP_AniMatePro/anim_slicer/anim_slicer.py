...
When pressing the button:
    - Hold SHIFT to display the options in a dialog.
    ...
    frame_start_range: bpy.props.IntProperty(
        ...
        default=0,
        min=0,
        description="Start Frame within the range to start keyframing from",
    ...
    def process_closest_full_frame(self, context, frame_range):
        ...
        self.insert_full_frames(slicer_frames_list)
