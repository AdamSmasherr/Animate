...
class AMP_PT_AniMateProGraph(bpy.types.Panel):
    ...
    def draw_header(self, context):
        layout = self.layout
        layout.label(text="", icon_value=(utils.customIcons.get_icon_id("AniMateProContact")))
...
classes = (
    ...
    # AMP_PT_TimelineToolsGraph,
    # AMP_PT_TimelineToolsDope,
    # AMP_PT_TimelineToolsView,
    # AMP_PT_TimelineToolsNLA,
