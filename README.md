...
[![Blender](https://img.shields.io/badge/Blender-5.1-orange?logo=blender&logoColor=white)](https://www.blender.org)
[![License](https://img.shields.io/badge/License-GPL%203.0-blue)](#credits-and-license)
[![Release](https://img.shields.io/github/v/release/AdamSmasherr/Animate?color=2ea44f)](https://github.com/AdamSmasherr/Animate/releases)

<img src="docs/images/onion_skin.png" alt="AniMate Pro onion skinning on a rigged character" width="760">

A toolkit for character and motion animators: timeline scrubbing, curve
sculpting, retiming, motion paths, pose tools, selection sets, GPU onion skinning
and dozens more, surfaced right inside the Graph Editor, Dope Sheet, Timeline and
3D Viewport.

[Installation](#installation) &nbsp;&middot;&nbsp; [Highlights](#highlights) &nbsp;&middot;&nbsp; [Tool reference](#tool-reference) &nbsp;&middot;&nbsp; [Documentation](#documentation)
...
GPU onion skinning in the 3D viewport for armatures and any animated object. Pick
how the ghost frames are chosen (Snapshots, Frame Step, On Keyframes, or explicit
Before and After offsets), colour code past and future with a distance based
alpha gradient, and switch between X-Ray and Solid render modes with an optional
screen door dither. The bake is vectorised with NumPy and caches a GPU batch per
frame, so even a heavy character rig stays interactive.

<table>
<tr>
<td width="50%"><img src="docs/images/onion_skin.png" alt="X-Ray ghosts"></td>
<td width="50%"><img src="docs/images/onion_dither.png" alt="Solid Dither"></td>
</tr>
<tr>
<td align="center"><sub>X-Ray ghosts trace the motion</sub></td>
<td align="center"><sub>Solid Dither, a screen door GLSL pattern</sub></td>
</tr>
</table>

### Time Visualizer

A GPU overlay for the Dope Sheet and Timeline that draws per second tick lines,
alternating checker bands, frame ticks, and second or timecode labels, so spacing
reads in real time units.

<img src="docs/images/time_visualizer.png" alt="Time Visualizer overlay on a character action" width="820">

### Built for Blender 5.1

This build is backed by a 204 item audit (see [docs/AUDIT.md](docs/AUDIT.md))
with more than 150 behaviour preserving fixes covering layered and slotted
actions (4.4+), draw and depsgraph handler leaks, crash paths and dead code.

---

## Installation

1. Download the latest `AMP_AniMatePro_vX.Y.zip` from the
   [Releases](https://github.com/AdamSmasherr/Animate/releases) page. Every push
   to `main` publishes a fresh, version stamped build. You can also build one
   locally with `python build.py`.
2. In Blender 5.1 open **Edit > Preferences > Add-ons**.
3. Use the dropdown at the top right, choose **Install from Disk**, and pick the
   zip.
4. Enable **AniMate - AniMate Pro**.

The tools live in the **Graph Editor and Dope Sheet header**, grouped into the
categories listed below, and in the **3D Viewport sidebar** (`N`, Animation tab)
for Onion Skins. Most tools open an options popover; the screenshots in the
reference show those panels, captured on the example rig.

---

## Tool reference

Every tool in the add-on, grouped by the category it appears under. Click a
category to expand it. Tools that open an options popover include a screenshot of
that panel.

<details>
<summary><b>Flagship</b> &nbsp; <sub>Onion Skin, Time Visualizer</sub></summary>

#### Onion Skin

<img align="right" width="300" src="docs/images/tool_onion_skin.png" alt="Onion Skin options">
...
<img align="right" width="300" src="docs/images/tool_time_visualizer.png" alt="Time Visualizer options">
...
<details>
<summary><b>Tools</b> &nbsp; <sub>Anim Loop, Anim Sculpt, Anim Curves, Anim TimeWarper, Anim Shift, Scrubbing, Anim Lattice, Anim Slice, Anim Blast</sub></summary>
...
<img align="right" width="300" src="docs/images/tool_anim_sculpt.png" alt="Anim Sculpt options">
...
<img align="right" width="300" src="docs/images/tool_anim_curves.png" alt="Anim Curves options">
...
<img align="right" width="300" src="docs/images/tool_timewarper.png" alt="Anim TimeWarper options">
...
<img align="right" width="300" src="docs/images/tool_anim_lattice.png" alt="Anim Lattice options">
...
<img align="right" width="300" src="docs/images/tool_anim_blast.png" alt="Anim Blast options">
...
<details>
<summary><b>Keyframes</b> &nbsp; <sub>Copy/Paste Pose, AnimOffset, Match Keyframes, Keyframer, Share Keyframes, Nudge Keyframes, InBetweens</sub></summary>
...
<img align="right" width="300" src="docs/images/tool_keyframer.png" alt="Keyframer options">
...
<details>
<summary><b>Toggles</b> &nbsp; <sub>Isolate Character, Realtime Looper, Flex Mopaths, Realtime Mopaths, Silhouette</sub></summary>
...
<img align="right" width="300" src="docs/images/tool_flex_mopaths.png" alt="Flex Mopaths options">
...
<img align="right" width="300" src="docs/images/tool_realtime_mopaths.png" alt="Realtime Mopaths options">
...
<details>
<summary><b>Utilities</b> &nbsp; <sub>Euler Filter, Euler Gimbal, Smart Keyframes, Markers, Delete All Markers, Lock/Unlock Markers</sub></summary>

#### Euler Filter

<img align="right" width="300" src="docs/images/tool_euler.png" alt="Euler Filter options">
...
<details>
<summary><b>View and framing</b> &nbsp; <sub>Normalize, Smart Zoom, Frame selected/all, Frame Action, Solo</sub></summary>
...
<details>
<summary><b>Selection</b> &nbsp; <sub>Selection Sets, Select All, Select Loc, Select Rot, Select Scale, Select CustomProps, Select ShapeKeys, Select Constraints, Show Handles, Only Handles for Selected</sub></summary>

#### Selection Sets

<img align="right" width="300" src="docs/images/tool_selection_sets.png" alt="Selection Sets options">
...
<details>
<summary><b>Editor switches</b> &nbsp; <sub>Graph Editor, Dope Sheet, Action Editor, Shape Key Editor, Grease Pencil Editor, Mask Editor, Cache File Editor, NLA Editor</sub></summary>
...
<details>
<summary><b>Sidebar tools</b> &nbsp; <sub>Stepper, Camera Stepper, AutoKeying, Anim Baker</sub></summary>

#### Stepper

<img align="right" width="300" src="docs/images/tool_stepper.png" alt="Stepper options">
...
<img align="right" width="300" src="docs/images/tool_camera_stepper.png" alt="Camera Stepper options">
...
| --- | --- |
| [docs/TOOLS.md](docs/TOOLS.md) | The tool reference as a standalone page. |
| [docs/FEATURES.md](docs/FEATURES.md) | Onion Skin and Time Visualizer in depth, with in Blender test steps. |
| [docs/AUDIT.md](docs/AUDIT.md) | The full Blender 5.1 audit and the applied fixes. |
| [docs/TOOL_CONCEPTS.md](docs/TOOL_CONCEPTS.md) | Designs for two future flagship tools, Whiplash and Groundwork. |

## Releases and versioning

Versions follow `MAJOR.MINOR`, where `MINOR` is the repository commit count. The
GitHub Actions workflow runs on every push to `main`: it stamps the version into
the manifest, builds `AMP_AniMatePro_vMAJOR.MINOR.zip`, and publishes a new
GitHub Release with that zip attached. Each push produces a new, incrementing
release. Build the same zip locally with `python build.py`.
