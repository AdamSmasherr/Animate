...
**KEYTYPE_KEYFRAME_VEC** Highlights
—————————————————
- Full Blender 5.1 Support & Compatibility!
- Complete Grease Pencil v3 migration.
- Fully compatible with the new Action slots and layered actions animation system.

**FUND** New features
—————————————————
- Native support for Blender 5.1's F-Curve nested layered actions channelbags.
- Graceful fallbacks ensuring total compatibility down to Blender 4.1.
- Updated Graph Editor and Dopesheet headers for 5.1 integration.
