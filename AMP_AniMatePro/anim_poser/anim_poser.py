    ...
    def update_isolate_character(self, context):
        if self.isolate_character:
            ...
            if context.mode == "POSE":
                enable_isolate_character(context, self)
        else:
            ...
            disable_isolate_character(context, self)
            self.previous_mode = ""
...
def deferred_isolate_character_handler():
    ...
    try:
        ...
        if props.previous_mode != current_mode:
            if current_mode == "POSE":
                enable_isolate_character(bpy.context, props)
